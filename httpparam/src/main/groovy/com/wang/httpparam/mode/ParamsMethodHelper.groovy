 ...
 * Date: 2019/3/28
 */
class ParamsMethodHelper extends MethodHelper implements Opcodes {
    ...
    protected Label init(MethodVisitor mv) {
        if (root) {
            mv.visitTypeInsn(NEW, mConfig.androidx ? "androidx/collection/ArrayMap" : "android.support.v4.util.ArrayMap")
            mv.visitInsn(DUP)
            mv.visitMethodInsn(INVOKESPECIAL, mConfig.androidx ? "androidx/collection/ArrayMap" : "android.support.v4.util.ArrayMap", "<init>", "()V", false)
    ...
    private void addStringField(MethodVisitor mv, KField field) {
        if (field.isNullable) {
            if (mConfig.add) {
                ...
                mv.visitLabel(l1)
                mv.visitFrame(F_FULL, 2, [mClassName, "java/util/Map"] as Object[], 2, ["java/util/Map", "java/lang/String"] as Object[])
                mv.visitVarInsn(ALOAD, 0)
                mv.visitFieldInsn(GETFIELD, mClassName, field.name, field.descriptor)
                field.toString(mv) //toString
                mv.visitLabel(l2)
                mv.visitFrame(F_FULL, 2, [mClassName, "java/util/Map"] as Object[], 3, ["java/util/Map", "java/lang/String", "java/lang/String"] as Object[])
                ...
                if (mSame) {
                    ...
                    mv.visitFrame(F_APPEND, 1, ["java/util/Map"] as Object[], 0, null)
                    mSame = true
                }
            }
        } else {
    ...
    private void addObjectField(MethodVisitor mv, KField field) {
        if (field.isNullable) {
            if (mConfig.add) {
                ...
                mv.visitFieldInsn(GETFIELD, mClassName, field.name, field.descriptor)
                mv.visitLabel(l2)
                mv.visitFrame(F_FULL, 2, [mClassName, "java/util/Map"] as Object[], 3, ["java/util/Map", "java/lang/String", "java/io/Serializable"] as Object[])
                mv.visitMethodInsn(INVOKEINTERFACE, "java/util/Map", "put", "(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;", true)
                mv.visitInsn(POP)
                Label l3 = new Label()
                mv.visitLabel(l3)
        ...
        if (field.isNullable) {
            if (mConfig.add) {
                ...
                if (!mConfig.okHttpV4) {
                    ...
                    mv.visitJumpInsn(GOTO, l2)
                    mv.visitLabel(l1)
                    mv.visitFrame(F_FULL, 2, [mClassName, "java/util/Map"] as Object[], 3, ["java/util/Map", "java/lang/String", "okhttp3/MediaType"] as Object[])
                    mv.visitVarInsn(ALOAD, 0)
                    mv.visitFieldInsn(GETFIELD, mClassName, field.name, field.descriptor)
                    field.toString(mv)
                    mv.visitLabel(l2)
                    mv.visitFrame(F_FULL, 2, [mClassName, "java/util/Map"] as Object[], 4, ["java/util/Map", "java/lang/String", "okhttp3/MediaType", "java/lang/String"] as Object[])

                    //created
                    mv.visitMethodInsn(INVOKESTATIC, "okhttp3/RequestBody", "create", "(Lokhttp3/MediaType;Ljava/lang/String;)Lokhttp3/RequestBody;", false)
                } else {
                    //created
                    mv.visitMethodInsn(INVOKESTATIC, "okhttp3/RequestBody", "create", "(Ljava/lang/String;Lokhttp3/MediaType;)Lokhttp3/RequestBody;", false)
                }
    ...
    protected void addFilesArrayField(MethodVisitor mv, KField field) {
        ...
        mv.visitLabel(l3)
        if (mArrayFirst) {
            mv.visitFrame(F_FULL, 5, [mClassName, "java/util/Map", field.descriptor, INTEGER, INTEGER] as Object[], 0, [] as Object[])
            mArrayFirst = false
        } else {
     ...
     */
    private void addRequestBody(MethodVisitor mv, KField field, int index) {
        mv.visitVarInsn(ALOAD, 1)
        mv.visitTypeInsn(NEW, "java/lang/StringBuilder")
        mv.visitInsn(DUP)
        mv.visitMethodInsn(INVOKESPECIAL, "java/lang/StringBuilder", "<init>", "()V", false)
